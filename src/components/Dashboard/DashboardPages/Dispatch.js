...
import NewModal from "../../Deliveries/NewModal";
	...
	return (
		<div className="card">
			<div className="cardbody">
				<div className="Deliveries-wrapper-dashboard">
					<Formik
						initialValues={{
							item: "",
							quantity: "",
					...
					>
						{({
							...
							<form onSubmit={handleSubmit}>
								<div className="new-dispatch-dashbaord">
